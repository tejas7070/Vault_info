...
RSpec.describe "/information", type: :request do
  ...
  describe "POST /create" do
    context "with valid parameters" do
      it "creates a new Information" do
        expect {
          post information_index_url, params: { information: valid_attributes }
        }.to change(Information, :count).by(1)
      end

      it "redirects to the created information" do
        post information_index_url, params: { information: valid_attributes }
        expect(response).to redirect_to(information_url(Information.last))
      end
    end
    ...
    context "with invalid parameters" do
      it "does not create a new Information" do
        expect {
          post information_index_url, params: { information: invalid_attributes }
  ...
  describe "PATCH /update" do
    context "with valid parameters" do
      ...
      it "updates the requested information" do
        information = Information.create! valid_attributes
        patch information_url(information), params: { information: new_attributes }
        information.reload
      ...
      it "redirects to the information" do
        ...
        patch information_url(information), params: { information: new_attributes }
        information.reload
        expect(response).to redirect_to(information_url(information))
      end
    end
    ...
    context "with invalid parameters" do
      it "renders a response with 422 status (i.e. to display the 'edit' template)" do
        information = Information.create! valid_attributes
        patch information_url(information), params: { information: invalid_attributes }
        expect(response).to have_http_status(:unprocessable_entity)
      end
    end
  end
  ...
  describe "DELETE /destroy" do
    ...
    it "redirects to the information list" do
      information = Information.create! valid_attributes
      delete information_url(information)
      expect(response).to redirect_to(information_index_url)
    end
  end
end
